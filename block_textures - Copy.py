...
BLOCK_DATA = {
    ...
    BlockType.OAK_DOOR: {
        "color":       color.rgb(170, 140, 85),
        "texture":     f"{TEX_BASE}/oak_door_bottom.png",
        "solid":       True, "transparent": True, "drops": "oak_door",
    },
    BlockType.OAK_BOAT: {
        "color":       color.rgb(160, 130, 80),
        "texture":     "textures/assets/minecraft/textures/item/oak_boat.png",
        "solid":       True, "transparent": True, "drops": "oak_boat",
    },
